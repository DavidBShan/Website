...
const ServicesDetails = [
  ...
  },
  {
    ...
    description: `Having completed and gotten a 5 in AP Computer Science at the age of 15, I have worked with many general purpose programming languages, starting from Python at the age of 10 to C++ which I use right now for numerous contests and learning all types of data structures and algorithms, ranging from Djikstra's Algorithm to Fenwick's Tree.`
  },
  {
...
const ServiceTow = ({ className, ...restProps }: DsnGridProps) => {
  return (
    <DsnGrid
      className={dsnCN('dsn-services service-tow', className)}
      {...restProps}
    >
